...
1. What is the DOM?
The DOM  defines the  structure of documents and the way a document is accessed and manipulated. 
2. What is an event?
 events are actions that occur as a result of the user action or as result of state change of the elements of a DOM tree. 
3. What is an event listener?
An event listener a procedure in JavaScript that waits for an event to occur.
4. Why would we convert a NodeList into an Array?
So you can use array methods 
5. What is a component?
Components are functions used to reuse code . Kind of like an ingredient inside the DOM.
